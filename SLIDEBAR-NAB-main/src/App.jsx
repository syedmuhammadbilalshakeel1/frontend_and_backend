...
import side from "./asset/side-image.jpg"
  ...
  return (
    <>
      ...
      <section className="form h-auto ov dark:text-gray-100 dark:bg-slate-800 duration-100">
        ...
        <div className="logo fixed top-4 h-4" style={{background:"url('/white.png')"}}>
        ...
        <div className="flex">
          ...
          <div className="mx-auto  pt-32">
            <form
              ...
              className="space-y-4 w-96 border-slate-300  min-h-screen flex flex-col"
            >
              <h1 className="text-4xl font-Poppins">Welcome Back</h1>
          ...
          <div className="img w-1/2 h-20px bg-indigo-300 dark:bg-slate-600 md:flex items-center justify-center hidden">
